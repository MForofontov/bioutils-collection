...
try:
    import numpy
    from bioutils_collection.bioinformatics_functions.data_validation.validate_dna_sequence import (
...
def test_validate_dna_sequence_valid() -> None:
    """Test case 1: Test validation of a valid DNA sequence."""
...
def test_validate_dna_sequence_invalid_chars() -> None:
    """Test case 2: Test validation detects invalid characters."""
...
def test_validate_dna_sequence_lowercase() -> None:
    """Test case 3: Test validation detects lowercase letters."""
    result = validate_dna_sequence("atgc")
    assert result["is_valid"] is True
    assert result["length"] == 4
    assert result["invalid_chars"] == []
...
def test_validate_dna_sequence_ambiguous_not_allowed() -> None:
    """Test case 4: Test ambiguous codes rejected when not allowed."""
...
def test_validate_dna_sequence_ambiguous_allowed() -> None:
    """Test case 5: Test ambiguous codes accepted when allowed."""
