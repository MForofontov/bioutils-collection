...
def needleman_wunsch(
    ...
    match : int, optional
        Score for matching characters (by default 1).
    ...
    tuple[int, str, str]
        Tuple containing:
        - alignment_score: int, the optimal alignment score
        - aligned_seq1: str, first sequence with gaps
        - aligned_seq2: str, second sequence with gaps
    ...
    Examples
    --------
    >>> needleman_wunsch("ACGT", "ACT")
    (2, 'ACGT', 'AC-T')
    >>> needleman_wunsch("GAT", "GAAT")
    (2, 'G-AT', 'GAAT')
